...
/* FONTES
 *https://furnasdobrasil.wordpress.com/2017/09/14/vamos-dizer-aos-deputados-federais-que-somos-contra-a-privatizacao-do-sistema-eletrobras/?customize_changeset_uuid=7d8093f4-78a8-4da4-acbf-cc69e41c17ef 
 * 
 * 
 * 
 */
...
namespace NaoPrivatiza
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            comboBox1.SelectedIndex = rnd.Next(0,2);
 ...
 //*/ 
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try{
                ...
                {
                    count++;
                    label6.Text = String.Format("Enviando email para os deputados ({0}/{1})", count, emails.Count);
                    label6.Update();
                    if (first)
                        first = false;
                    ...
                    client.Send(message);
                    for (int i = message.Bcc.Count - 1; i >= 0;i-- )
                        message.Bcc.RemoveAt(i);
